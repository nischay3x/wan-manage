...
async function up () {
  try {
    ...
    logger.info('Device bgp.neighbors.sendCommunity database migration succeeded', {
      params: { collections: ['devices'], operation: 'up', res }
    });
  } catch (err) {
    logger.error('Device bgp.neighbors.sendCommunity database migration failed', {
